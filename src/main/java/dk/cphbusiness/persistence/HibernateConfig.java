...
public class HibernateConfig {
    ...
    private static void getAnnotationConfiguration(Configuration configuration) {
        configuration.addAnnotatedClass(dk.cphbusiness.security.entities.User.class);
        configuration.addAnnotatedClass(dk.cphbusiness.security.entities.Role.class);
    }
